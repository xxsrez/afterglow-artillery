...
Документация отделяет уже реализованный vertical slice от более широкого
замысла и предлагаемых этапов после него.
...
2. [Реализация](implementation.md) — что действительно работает сейчас.
...
7. [Оригинальная игра](reference/original-game.md) — источник механик, цен и
   неизвестных параметров Scorched Earth 1.5.
