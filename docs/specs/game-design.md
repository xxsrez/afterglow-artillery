...
- Motif задаёт не только верхнюю линию, но и упорядоченные операции material
  ...
  Seeded noise добавляет локальную неровность после композиции и не выбирает
  её макроструктуру. Независимая legacy-генерация случайных caves/tunnels в
  Quick Demo отключена: все объёмные пустоты принадлежат выбранному motif.
...
- Равновзвешенное default-расписание не повторяет одно семейство во всех трёх
  ...
  Семейство, motif, spawn kinds, topology/structure metrics, число попыток и
  fallback входят в детерминированные metadata. Решение и границы
  каноничности зафиксированы в
